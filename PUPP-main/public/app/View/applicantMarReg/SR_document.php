    ...
    <div style="border: 2px solid black; background-color: #D9D9D9; height: auto;" class="container-content w-75 p-3 ">
        ...
        <form>
            <div style="height: auto; position: relative; top: 20px;"
                ...
                <p>1. Salinan kad pengenalan suami dan isteri</p>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="inputGroupFile01">
                    <label class="input-group-text" for="inputGroupFile01">Upload</label>
                </div>

                <p>2. Pengesahan Memeluk Agama Islam (Bagi Pasangan Yang Memeluk Islam)</p>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="inputGroupFile02">
                    <label class="input-group-text" for="inputGroupFile02">Upload</label>
                </div>

                <p>3. Surat Perakuan Nikah (Dikeluarkan Oleh Jabatan Pendaftaran Negara Bagi Pasangan Yang Memeluk Agam Islam)</p>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="inputGroupFile03">
                    <label class="input-group-text" for="inputGroupFile03">Upload</label>
                </div>

                <p>4. Surat Akuan Pemastautin</p>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="inputGroupFile04">
                    <label class="input-group-text" for="inputGroupFile04">Upload</label>
                </div>

                <p>5. Gambar Berukuran Passport (Latar Belakang Putih) 1 Keping Bagi Pengantin Lelaki Bersongkok</p>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="inputGroupFile05">
                    <label class="input-group-text" for="inputGroupFile05">Upload</label>
                </div>

                <p>6. Gambar Berukuran Passport (Latar Belakang Putih) 1 Keping Bagi Pengantin Perempuan Bertudung Gelap</p>
                <div class="input-group mb-3">
