    ...
    <div style="border: 2px solid black; background-color: #D9D9D9; height: auto;" class="container-content w-75 p-3 ">
        ...
        <form>
            <div style="height: auto; position: relative; top: 20px;"
                ...
                <center>
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../../../app/View/staffMarReg/wifeForm.php">MAKLUMAT
                                ISTERI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="../../../app/View/staffMarReg/marriageForm.php">MAKLUMAT PERKAHWINAN</a>
                        </li>
                    </ul>
                </center>
            ...
            <button type="submit" class="btn">
                <a class="text-light" href="../../../app/View/staffMarReg/wifeForm.php">Kembali</a>
            </button>
            <button type="submit" class="btn">
                <a class="text-light" href="../../../app/View/staffMarReg/DL_document.php">Teruskan</a>
            </button>
        </form>
