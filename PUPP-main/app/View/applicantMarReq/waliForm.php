    ...
    <div class="content">
        <div class="menu-form">
             ...
             <div class="content-text2">
                ...
                <div>
                    <label for="nama"><b>Nama Wali:</b></label>
                    <input type="text" id="nama" name="nama"><br><br>
                </div>


                <label for="address"><b>Alamat Wali:</b></label>
                    <textarea id="subject" name="subject"  style="height: 3px 0px"></textarea><br><br>
                 </div>
                
                 <label for="tarikh">Tarikh Lahir Wali:</label>
                <input type="date" id="tarikh" name="tarikh"><br><br>

                <div>
                 <label for="age">Umur Wali:</label>
                <input type="number" id="age" name="age"><br><br>
                 </div>

                 <div>
                    <label for="phonenum"><b>No.Telefon Wali:</b></label>
                    <input type="text" id="phonenum" name="phonenum"><br><br>
                 </div>
    
                 <div>
                    <label for="relationship"><b>Hubungan:</b></label>
