            ...
            <div style="height: auto; position: relative; top: 20px;"
                ...
                <center>
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="../../../app/View/staffMarReg/wifeForm.php">MAKLUMAT SUAMI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="../../../app/View/staffMarReg/wifeForm.php">MAKLUMAT ISTERI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../../app/View/staffMarReg/marriageForm.php">MAKLUMAT
                                PERKAHWINAN</a>
                        </li>
                    </ul>
                </center>
                ...
                <form>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="partner_IC" id="partner_IC" class="form-control"
                                value="<?php echo $array['partner_IC']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="partner_name" id="partner_name" class="form-control"
                                value="<?php echo $array['partner_Name']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="partner_DOB" id="partner_DOB" class="form-control"
                                value="<?php echo $array['partner_DOB']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="partner_age" id="partner_age" class="form-control"
                                value="<?php echo $array['partner_age']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="dropdown" name="partner_race" class="form-control"
                                value="<?php echo $array['partner_race']; ?>" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="dropdown" name="partner_Nationality" class="form-control"
                                value="<?php echo $array['partner_Nationality']; ?>" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="dropdown" name="partner_level_education" class="form-control"
                                value="<?php echo $array['partner_level_education']; ?>" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="dropdown" name="partner_work_sector" class="form-control"
                                value="<?php echo $array['partner_work_sector']; ?>" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="partner_Job" id="partner_Job" class="form-control"
                                value="<?php echo $array['partner_Job']; ?>" required />
                        </div>
                    </div>
