...
td, th {
  ...
  <body style="background-color: white;"> 
    ...
    <div class="content">
        <div class="menu-form">
                <h3> SENARAI PERMOHONAN KEBENARAN KAHWIN </h3>  
        </div>
        ...
        <p> Permohonan Untuk Kebenaran Berkahwin:<button>Lihat</button></p><br>
        <p> Persetujuan dan Wakalah Wali:<button>Lihat</button></p>
        <p> Akuan Pemastautinan:<button>Lihat</button></p>
        <p> Borang Ujian Saringan HIV Pemohon:<button>Lihat</button></p>
