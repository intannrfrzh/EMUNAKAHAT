  ...
  <div style="border: 2px solid black; background-color: #D9D9D9;" class="container-content w-75 p-3">
    ...
    <form>
      <div class="row mb-3">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" id="applicant_IC" name="applicant_IC" required class="form-control">
          </div>

          <div class="form-group">
            <label for="applicant_DOB">Tarikh Lahir:</label>
            <div class="d-flex">
              <select id="applicant_DOB" name="applicant_DOB" class="form-control mr-2">
                <?php
              ...
              <select id="dob_month" name="dob_month" class="form-control mr-2">
                <?php
                $months = array(
                  1 => 'January',
                  2 => 'February',
      ...
      <div class="text-center">
        <a class="btn btn-primary" href="userProfileView.php">Simpan</a>
      </div>
