    ...
    <div class="content">
        <div class="menu-form">
             ...
             <div class="content-text2">
                <p>Sila muat naik resit pembayaran untuk menyelesaikan proses permohonan kebenaran perkahwinan</p>
                <label for="formFile" class="form-label">Resit Pembayaran Permohonan Kebenaran Perkahwinan:</label><input class="form-control" type="file" id="formFile"><br>
