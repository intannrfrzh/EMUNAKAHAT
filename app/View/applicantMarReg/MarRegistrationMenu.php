  ...
  <div style="border: 2px solid black; background-color: #D9D9D9;" class="container-content w-75 p-3 ">
    ...
    <form>
      <div style="height: 520px;position: relative; top: 20px;"
        ...
        <div class="mb-3 row">
          <label id="kategori" for="kategori" class="col-sm-2 col-form-label">Kategori daftar perkahwinan : </label>
          <div class="col-sm-10">
            <select id="dropdown" name="kategori" class="form-control" required>
        ...
        <button type="submit" class="btn">
          <a class="text-light" href="../../../app/View/applicantMarReg/husbandForm.php">Teruskan</a>
        </button>
