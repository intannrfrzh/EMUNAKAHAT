    ...
    <div style="border: 2px solid black; background-color: #D9D9D9; height: auto;" class="container-content w-75 p-3 ">
        ...
        <form action="../../../public/index.php?action=husbandFormRet" id="husband-form" method="post">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="../../../app/View/staffMarReg/husbandForm.php">MAKLUMAT SUAMI</a>
                        </li>
                        <li class="nav-item">
            ...
            <button type="submit" class="btn">
                <a class="text-light" href="../../../app/View/staffMarReg/marRegistrationMenu.php">Kembali</a>
            </button>
            <button type="submit" class="btn">
                <a class="text-light" href="../../../app/View/staffMarReg/wifeForm.php">Teruskan</a>
            </button>
        </form>
